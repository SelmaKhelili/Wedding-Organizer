...
class _EditprofileVendorState extends State<EditprofileVendor> {
  ...
  Widget build(BuildContext context) {
    final String currentUserEmail =
        ModalRoute.of(context)?.settings.arguments as String? ?? 'unknown@domain.com';
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                filled: true,
                fillColor: Color.fromARGB(92, 255, 207, 247), // Background color
                border: OutlineInputBorder(
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    color: Color.fromARGB(255, 181, 88, 139), // Border color when focused
                    width: 2,
                  ),
                ),
              ),
            ...
            Visibility(
              ...
              child: Row(
                ...
                children: [
                  Text("Add myself as Vendor"),
                  Switch(
                    value: showVendor,
                    activeColor: Color.fromARGB(255, 158, 4, 86),
                    onChanged: (value) {
                      setState(() {
                        showVendor = value;
                    ...
                    children: [
                      ...
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          items: [
                            DropdownMenuItem(value: '[0-5000]', child: Text('[0-5000]')),
                            DropdownMenuItem(value: '[5000-10000]', child: Text('[5000-10000]')),
                            DropdownMenuItem(value: '[10000-15000]', child: Text('[10000-15000]')),
                            DropdownMenuItem(value: '[20000-25000]', child: Text('[20000-25000]')),
                            DropdownMenuItem(value: '[25000-30000]', child: Text('[25000-30000]')),
                            DropdownMenuItem(value: '[ > 30000]', child: Text('[ > 30000]')),
                          ],
                          onChanged: (value) {
                            setState(() {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(92, 255, 207, 247), // Background color
                        borderRadius: BorderRadius.circular(12), // Rounded corners
                        border: Border.all(
                          color: const Color.fromARGB(255, 181, 88, 139), // Border color
                          width: 2,
                        ),
                      ),
                      child: Row(
